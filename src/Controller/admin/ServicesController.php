...
class ServicesController extends AbstractController
{
    ...
    public function index(ServicesRepository $servicesRepository, EntrepriseRepository $entrepriseRepository): Response
    {
    ...
    public function show(Services $service, EntrepriseRepository $entrepriseRepository): Response
    {
    ...
    public function edit(Request $request, Services $service, EntityManagerInterface $entityManager, EntrepriseRepository $entrepriseRepository): Response
    {
        $form = $this->createForm(ServicesType::class, $service);
        $form->handleRequest($request);
