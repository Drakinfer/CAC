...
class ServiceEquipeController extends AbstractController
{
    ...
    public function show(ServiceEquipe $serviceEquipe, EntrepriseRepository $entrepriseRepository, ReseauxRepository $reseauxRepository): Response
    {
    ...
    public function edit(Request $request, ServiceEquipe $serviceEquipe, EntityManagerInterface $entityManager, EntrepriseRepository $entrepriseRepository, ReseauxRepository $reseauxRepository): Response
    {
        $form = $this->createForm(ServiceEquipeType::class, $serviceEquipe);
        $form->handleRequest($request);
